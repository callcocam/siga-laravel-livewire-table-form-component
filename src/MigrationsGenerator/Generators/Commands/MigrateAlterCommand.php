...
use Call\MigrationsGenerator\Generators\Commands\GeneratorCommand;
...
class MigrateAlterCommand extends GeneratorCommand {

	/**
	 * The console command name.
	 * @var string
	 */
	protected $name = 'migrate:alter';

	/**
	 * The console command description.
	 * @var string
	 */
	protected $description = 'Alter a migration from an existing table structure.';
