...
class Icons extends Component
{
    ...
    {
        return view(call_views('admin.utils.icons'));
    }

    public function icons(){
        $listIcons = collect($this->listIcons);
        if(empty($this->search))
            return $listIcons->all();

        $newCollection = $listIcons->filter(function ($search){
            return Str::contains($search, $this->search);
        });
